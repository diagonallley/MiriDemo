    ...
    public class MiriIdController : Controller
    {
        ...
        public ActionResult RegisterUser(string firstname, string lastname, string email, string mobile, string camimage, string _phoneCode, HttpPostedFileBase file, string productcode = "1", string designation = "", string company = "")
        {
            ...
            try
            {
                ...
                //req.IssuerNumber = "14";
                req.IssuerNumber = ConfigurationManager.AppSettings["ID_ISSUER"];
                ...
                //Root res = new demoClass().RegisterUser(req);
                string auth = "487953201619382560741643098752382609";
                ActivationCodeRes.Root ActiveCode = demoClass.CreateProfileAccountGetActivationCode(auth, req);

               // string userprofilenumber = res.resp.TheAccountView.ProfileId.ToString();
        ...
        public string ValidateMiriID(string id)
        {
            ...
            MtlMiriDemo_V1.Controllers.MiriIdTransactionResult res = new demoClass().MiriIdTransactionRest(id);
        ...
        private bool ValidateDemoUser(string userid)
        {
            ...
            //DataSet ds=MyAPi.GetDataSetByCommand("get_user_data");
            DataSet ds = sql.GetDatasetByCommand("get_user_data");
            //String str = sql.GetDataStored("get_user_data");
